...
def parse_arguments(command):
    ...
    parser.add_argument(
        "--api", "-a", action="store_true", help="Sets a custom API key for socli"
    )
    parser.add_argument(
        "--delete",
        "-d",
    ...
    parser.add_argument(
        ...
        "-t",
        nargs="+",
        help="To search a query by tag on stack overflow."
    ...
    parser.add_argument(
        ...
        "-r",
        type=int,
        help="To select and display a result manually and display "
    ...
    parser.add_argument(
        "--open-url", "-o", nargs=1, type=str, help="To load the given url"
    )
    parser.add_argument("--raw-output", type=bool, help="Write as json to stdout")

    parser.add_argument(
        "--version",
        "-v",
        action="store_true",
        help="Prints the current version of socli",
    )
